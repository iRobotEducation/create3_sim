...
WheelDrop::WheelDrop(std::shared_ptr<rclcpp::Node> &nh) : nh_(nh),
                                                                  ...
                                                                  "wheel_drop_right_joint"}
{
    ...
    hazard_pub_[joints_[0]] = nh_->create_publisher<irobot_create_msgs::msg::HazardDetection>("_internal/wheel_drop/left_wheel/event", rclcpp::SensorDataQoS());
    hazard_pub_[joints_[1]] = nh_->create_publisher<irobot_create_msgs::msg::HazardDetection>("_internal/wheel_drop/right_wheel/event", rclcpp::SensorDataQoS());
