...
#include <irobot_create_toolbox/wheels_publisher_node.hpp>

namespace irobot_create_toolbox
{
WheelsPublisherNode::WheelsPublisherNode() : rclcpp::Node("wheels_publisher")
{
  ...
  timer_ = create_wall_timer(
    ...
    std::bind(&WheelsPublisherNode::publisher_callback, this));
...
void WheelsPublisherNode::publisher_callback()
{
  {  // Mutex scope
...
size_t WheelsPublisherNode::get_joint_index(std::string joint_name)
{
...
size_t WheelsPublisherNode::get_interface_index(std::string interface_name, size_t joint_index)
{
