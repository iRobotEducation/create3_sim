...
#include <irobot_create_toolbox/hazards_vector_publisher_node.hpp>

namespace irobot_create_toolbox
{
HazardsVectorPublisherNode::HazardsVectorPublisherNode() : rclcpp::Node("hazard_detection_vector")
{
