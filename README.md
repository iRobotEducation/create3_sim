...
1. At the moment there are some packages that need to be installed from source for Galactic because they aren't fully supported yet. Please install these via vcs.
